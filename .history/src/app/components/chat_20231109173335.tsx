...
const Chat = () => {
  ...
  const sendMessage = async () => {
    ...
    //OpenAIからの返信
    const gpt3Response = await openai.hat.completions.create({
      messages: [{role:"user", content: inputMessage},{role: "systcem", content:"2歳のゆうと君の父親として20字以内で楽しく会話してください"}],
      model: "gpt-3.5-turbo",
    });
  ...
  return (
    <div className="bg-gray-200 h-full p-4 flex flex-col">
      <h1 className="text-3xl text-black font-semibold mb-4">パパの部屋</h1>
      <div className="flex space-x-5">
          <Image src={pic} alt="sakura" width={160} height={70}  />
          <Image src={pic2} alt="sakura" width={160} height={70}  />
      </div>
