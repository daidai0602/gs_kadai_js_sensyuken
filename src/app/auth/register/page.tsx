  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center">
      ...
      className="bg-white p-8 rounded-lg shadow-md w-96" >
        <h1 className="mb-4 text-gray-700 text-2x1 font-medium">新規登録</h1>
          <div>
          ...
          <div className="flex justify-end">
            <button
            type="submit" className="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:text-blue-700">新規登録
            </button>
          </div>
          <div className="mt-4">
            ...
            <Link
            href={"/auth/login"}
            className="text-blue-500 text-sm font-bold ml-1 hover:text-blue-700">ログインページへ
            </Link>
          </div>
      </form>
    </div>
